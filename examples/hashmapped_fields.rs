...
}; // DataTypesCast is generated by the TypeCast derive macro in the examples/utils/mod.rs file. Rust-Analyzer mistakenly classifies this as an `unresolved import`
